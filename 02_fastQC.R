...
setwd(gcswd)
n = make.names(paste('CFastqQualityBatch data id 44 olga rds'))
...
df = data.frame(idData=g_did, name=n, type='rds', location='~/Data/MetaData/', comment='pre trim FASTQ quality checks on Olga mouse data')
